...
namespace Core.Rules
{
    public class ClassicRules : IRules
    {
        ...
        {
            return currentState ? neighborsCount >= 2 && neighborsCount <= 3 : neighborsCount == 3;
        }
        ...
        public bool CheckTheEnd(bool[,] field)
        {
            ...
            if (_previousStates.Count != 0 &&
                _previousStates.Any(previous => previous.SequenceEqual(newState)))
            {
                return true;
            }
        ...
        private bool CheckIsEmpty(bool[] field)
        {
            return field.All(cell => cell == false);
        }
    }
}